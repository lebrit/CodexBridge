...
- Приёмка установщика на Windows Server 2022/2025 выполняется последовательно; загрузка контрольного старого релиза ограничена 120 секундами и одной повторной попыткой, чтобы зависший внешний download не блокировал публикацию без диагностики.
